...
After performing exploratory data analysis, I imputed the missing values using mean, mode, regression, and regression with perturbation methods. 
  - For mean and mode imputation, I calculated the mean of the BareNuclei column, ignoring the null values, and then replaced the null values with the computations. This was repeated for mode as well. 
