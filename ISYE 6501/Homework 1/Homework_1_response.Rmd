...
Observations and interpretations: 
In the scaled knn model the highest accuracy is 86.73% while the unscaled one has the highest accuracy of 6972%. It seems that the unscaled model at its best under performs compared to the scaled model.
